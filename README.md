...
이 repo는 제품·디자인 시스템 작업에서 반복해서 쓸 수 있는 **운영 패턴과 판단 기준**을 정제합니다. 현재 Prism의 실제 컴포넌트/토큰/package 계약과 배포 기준은 `socraAI_product design` repo가 source of truth입니다.
...
- 디자인 시스템 원본 스펙, 토큰, 컴포넌트 문서: `socraAI_product design`에 관리
...
| `socraAI_product design` | Prism package, component/token contracts, Storybook, release workflow |
...
2. 구체적인 컴포넌트/토큰/package 판단은 먼저 `socraAI_product design`의 README, AGENTS, contract 문서를 확인한다.
...
1. [Figma / Storybook Role Lessons](wiki/guides/figma-first-storybook-verified.md)
2. [Figma / Git Sync Boundary](wiki/guides/figma-git-sync.md)
3. [Component Update Playbook](wiki/playbooks/component-update-playbook.md)
4. [Screen Design Playbook](wiki/playbooks/screen-design-playbook.md)
5. [AI Design Review](wiki/guides/ai-design-review.md)
6. [Daily Worklog to Wiki](wiki/guides/daily-worklog-to-wiki.md)
...
- `socraAI_product design`: Prism의 실제 package/component/token/Storybook 계약
- `socra-ai-workflow-guide`: 위 두 저장소에서 반복 가능하다고 확인된 운영 지식
